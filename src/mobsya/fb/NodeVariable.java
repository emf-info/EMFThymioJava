...
public final class NodeVariable extends Table {
  public static void ValidateVersion() { Constants.FLATBUFFERS_23_5_26(); }
  public static NodeVariable getRootAsNodeVariable(ByteBuffer _bb) { return getRootAsNodeVariable(_bb, new NodeVariable()); }
  public static NodeVariable getRootAsNodeVariable(ByteBuffer _bb, NodeVariable obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __reset(_i, _bb); }
  public NodeVariable __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static int createNodeVariable(FlatBufferBuilder builder,
      int nameOffset,
      int valueOffset) {
  ...
  public static void startNodeVariable(FlatBufferBuilder builder) { builder.startTable(2); }
  ...
  public static int endNodeVariable(FlatBufferBuilder builder) {
  ...
  public static NodeVariable __lookup_by_key(NodeVariable obj, int vectorLocation, String key, ByteBuffer bb) {
    ...
    while (span != 0) {
      ...
      if (comp > 0) {
        ...
        return (obj == null ? new NodeVariable() : obj).__assign(tableOffset, bb);
      }
    }
    return null;
  }
  ...
  public static final class Vector extends BaseVector {
    ...
    public NodeVariable get(int j) { return get(new NodeVariable(), j); }
    public NodeVariable get(NodeVariable obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
    public NodeVariable getByKey(String key) {  return __lookup_by_key(null, __vector(), key, bb); }
    public NodeVariable getByKey(NodeVariable obj, String key) {  return __lookup_by_key(obj, __vector(), key, bb); }
  }
}
